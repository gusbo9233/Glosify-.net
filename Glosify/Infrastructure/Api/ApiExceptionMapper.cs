...
public static class ApiExceptionMapper
{
    public static ApiError? Map(Exception exception) => exception switch
    {
        ...
        InsufficientAiCreditsException => new ApiError(402, ApiErrorCodes.PaymentRequired,
            new Glosify.Localization.UiTextStringLocalizer()["Payments.InsufficientExactBalance"].Value),
