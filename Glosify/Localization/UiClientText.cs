...
public static class UiClientText
{
    ...
    [
        ...
        "Client.DeleteQuizConfirm", "Client.DeleteQuizFailed", "Client.RepairFailed",
        "Client.RepairStopped", "Client.DeleteChat", "Client.DeleteChatConfirm",
        ...
        "Quiz.Progress", "Quiz.CorrectCount", "Quiz.CheckAnswer", "Quiz.Repair",
