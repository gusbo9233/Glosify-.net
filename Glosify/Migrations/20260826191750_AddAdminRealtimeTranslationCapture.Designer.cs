...
namespace Glosify.Migrations
{
    ...
    [Migration("20260826191750_AddAdminRealtimeTranslationCapture")]
    partial class AddAdminRealtimeTranslationCapture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Glosify.Models.Entities.RealtimeTranslationCaptureEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("ProviderRequest")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("SessionId", "Stage", "CapturedAt");

                    b.ToTable("RealtimeTranslationCaptureEvents", t =>
                        {
                            t.HasCheckConstraint("CK_RealtimeTranslationCaptureEvents_Kind", "[Kind] IN ('partial', 'final')");

                            t.HasCheckConstraint("CK_RealtimeTranslationCaptureEvents_Stage", "[Stage] IN ('scribe', 'translator', 'bubble')");
                        });
                });
